                ...
                <x-input.label for="terms_of_service_and_privacy_policy" class="text-center">
                    {!! __('By continuing, I agree to the :terms_of_service and :privacy_policy', [
                        'terms_of_service' =>
                            ...
                            '" class="text-sm text-indigo-600 rounded-md hover:underline focus:underline dark:text-indigo-400 hover:text-indigo-70000 dark:dark:hover:text-indigo-30000 focus:text-indigo-70000 dark:dark:focus:text-indigo-30000">' .
                            __('Terms of Service') .
                            '</a>',
                        'privacy_policy' =>
                            '<a target="_blank" href="' .
