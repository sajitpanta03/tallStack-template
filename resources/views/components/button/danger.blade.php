...
<button
    {{ $attributes->merge([
        'type' => 'button',
        'class' =>
            'inline-flex items-center justify-center px-3 py-2 text-sm font-semibold border rounded-md text-zinc-950 dark:text-zinc-50 bg-red-100 dark:bg-red-950 hover:bg-red-200 dark:hover:bg-red-800 focus:bg-red-200 dark:focus:bg-red-800 border-red-200 dark:border-red-800',
    ]) }}
