...
<button
    {{ $attributes->merge([
        'type' => 'submit',
        'class' =>
            'inline-flex items-center justify-center px-3 py-2 text-sm font-semibold border rounded-md text-zinc-950 dark:text-zinc-50 bg-zinc-100 dark:bg-zinc-950 hover:bg-zinc-200 dark:hover:bg-zinc-800 focus:bg-zinc-200 dark:focus:bg-zinc-800 border-zinc-200 dark:border-zinc-800',
    ]) }}
