...
<button
    {{ $attributes->merge([
        'type' => 'submit',
        'class' =>
            'inline-flex items-center justify-center px-3 py-2 text-sm font-semibold text-zinc-50 border rounded-md dark:text-zinc-950 bg-zinc-950 dark:bg-zinc-50 hover:bg-zinc-800 dark:hover:bg-zinc-300 focus:bg-zinc-800 dark:focus:bg-zinc-300 border-zinc-800 dark:border-zinc-300',
    ]) }}
