                            ...
                            @guest
                                <li>
                                    <a href="{{ route('login') }}" wire:navigate
                                        class="text-sm text-zinc-600 dark:text-zinc-400 hover:text-indigo-600 dark:hover:text-indigo-400 focus:text-indigo-600 dark:focus:text-indigo-400 focus:outline-hidden">
                                        {{ __('Login') }}
                                    </a>
                                </li>
                                <li>
            ...
            <div class="flex mt-12 xl:justify-center">
                <span class="text-sm text-zinc-600 dark:text-zinc-400">
                    ...
                    <a href="https://github.com/arifbudimanar"
                        class="hover:text-indigo-600 dark:hover:text-indigo-400 focus:text-indigo-600 dark:focus:text-indigo-400 focus:outline-hidden"
